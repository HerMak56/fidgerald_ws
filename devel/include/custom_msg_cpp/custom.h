// Generated by gencpp from file custom_msg_cpp/custom.msg
// DO NOT EDIT!


#ifndef CUSTOM_MSG_CPP_MESSAGE_CUSTOM_H
#define CUSTOM_MSG_CPP_MESSAGE_CUSTOM_H
...
struct custom_
{
  ...
  typedef boost::shared_ptr< ::custom_msg_cpp::custom_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::custom_msg_cpp::custom_<ContainerAllocator> const> ConstPtr;

}; // struct custom_

typedef ::custom_msg_cpp::custom_<std::allocator<void> > custom;

typedef boost::shared_ptr< ::custom_msg_cpp::custom > customPtr;
typedef boost::shared_ptr< ::custom_msg_cpp::custom const> customConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::custom_msg_cpp::custom_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::custom_msg_cpp::custom_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::custom_msg_cpp::custom_<ContainerAllocator1> & lhs, const ::custom_msg_cpp::custom_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::custom_msg_cpp::custom_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::custom_msg_cpp::custom_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::custom_msg_cpp::custom_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::custom_msg_cpp::custom_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::custom_msg_cpp::custom_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::custom_msg_cpp::custom_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::custom_msg_cpp::custom_<ContainerAllocator> >
{
  ...
  static const char* value(const ::custom_msg_cpp::custom_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x128e291c79655ee6ULL;
  static const uint64_t static_value2 = 0xdf15d3b35f1bf391ULL;
};

template<class ContainerAllocator>
struct DataType< ::custom_msg_cpp::custom_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::custom_msg_cpp::custom_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::custom_msg_cpp::custom_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::custom_msg_cpp::custom_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::custom_msg_cpp::custom_<ContainerAllocator>& v)
  {
    s << indent << "x_R: ";
    s << std::endl;
...
#endif // CUSTOM_MSG_CPP_MESSAGE_CUSTOM_H
