...
(cl:defmethod cl:initialize-instance :after ((m <custom>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'custom)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_messages-msg:<custom> is deprecated: use custom_messages-msg:custom instead.")))

(cl:ensure-generic-function 'x_R-val :lambda-list '(m))
(cl:defmethod x_R-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:x_R-val is deprecated.  Use custom_messages-msg:x_R instead.")
  (x_R m))

(cl:ensure-generic-function 'y_R-val :lambda-list '(m))
(cl:defmethod y_R-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:y_R-val is deprecated.  Use custom_messages-msg:y_R instead.")
  (y_R m))

(cl:ensure-generic-function 'z_R-val :lambda-list '(m))
(cl:defmethod z_R-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:z_R-val is deprecated.  Use custom_messages-msg:z_R instead.")
  (z_R m))

(cl:ensure-generic-function 'alpha_R-val :lambda-list '(m))
(cl:defmethod alpha_R-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:alpha_R-val is deprecated.  Use custom_messages-msg:alpha_R instead.")
  (alpha_R m))

(cl:ensure-generic-function 'beta_R-val :lambda-list '(m))
(cl:defmethod beta_R-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:beta_R-val is deprecated.  Use custom_messages-msg:beta_R instead.")
  (beta_R m))

(cl:ensure-generic-function 'gamma_R-val :lambda-list '(m))
(cl:defmethod gamma_R-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:gamma_R-val is deprecated.  Use custom_messages-msg:gamma_R instead.")
  (gamma_R m))

(cl:ensure-generic-function 'x_L-val :lambda-list '(m))
(cl:defmethod x_L-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:x_L-val is deprecated.  Use custom_messages-msg:x_L instead.")
  (x_L m))

(cl:ensure-generic-function 'y_L-val :lambda-list '(m))
(cl:defmethod y_L-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:y_L-val is deprecated.  Use custom_messages-msg:y_L instead.")
  (y_L m))

(cl:ensure-generic-function 'z_L-val :lambda-list '(m))
(cl:defmethod z_L-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:z_L-val is deprecated.  Use custom_messages-msg:z_L instead.")
  (z_L m))

(cl:ensure-generic-function 'alpha_L-val :lambda-list '(m))
(cl:defmethod alpha_L-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:alpha_L-val is deprecated.  Use custom_messages-msg:alpha_L instead.")
  (alpha_L m))

(cl:ensure-generic-function 'beta_L-val :lambda-list '(m))
(cl:defmethod beta_L-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:beta_L-val is deprecated.  Use custom_messages-msg:beta_L instead.")
  (beta_L m))

(cl:ensure-generic-function 'gamma_L-val :lambda-list '(m))
(cl:defmethod gamma_L-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:gamma_L-val is deprecated.  Use custom_messages-msg:gamma_L instead.")
  (gamma_L m))
